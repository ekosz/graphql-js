...
var GraphQLUnionType = exports.GraphQLUnionType = function () {
  ...
  GraphQLUnionType.prototype._defineTypes = function _defineTypes() {
    var _this = this;

    var types = resolveThunk(this._typeConfig.types);
    (0, _invariant2.default)(Array.isArray(types) && types.length > 0, 'Must provide Array of types or a function which returns ' + ('such an array for Union ' + this.name + '.'));
